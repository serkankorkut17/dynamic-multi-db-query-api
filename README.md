...
> `DATEADD(HOUR,'2025-09-18T12:34:56',2)` => 2025-09-18T14:34:56<br>
> `DATEADD(SECOND,'2025-01-12T00:00:00',5)` => 2025-09-18T12:35:01

- DATEDIFF: unit can be SECOND, MINUTE, HOUR, DAY, WEEK, MONTH, YEAR
> `DATEDIFF(DAY,'2025-09-03','2025-09-18')` => 15<br>
> `DATEDIFF(YEAR,'2025-01-03','2026-01-02')` => 0

- DAY / MONTH / YEAR
> `YEAR('2025-09-18')` => 2025<br>
> `MONTH('2025-09-18')` => 12<br>
> `DAY('2025-09-18')` => 18

- DATENAME: unit can be MONTH or DAY
> `DATENAME(MONTH, '2025-09-18')` => 'SEPTEMBER' or 'September'<br>
